...
/*
  ...
  Changes from the original library:
   - imports, from Arduino and SPI to mbed and I2C libraries
   - changed class name from DFRobot_BMX160 to IMU_BMX160
   - class constructor's argument type changed from TwoWire to I2C
   - class attribute _pWire changed from TwoWire* to I2C*
*/
